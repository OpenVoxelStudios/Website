    ...
    return (
        <>
            <header className="header" id='header'>
                ...
                <img onClick={() => location.href = "https://discord.gg/Xhvb2wujVh"} className='coolclick icon' src={IconDiscord} />
            </header>
            ...
            <nav className="menu" style={{ left: menu ? "0" : "-100%" }} onMouseDown={(ev) => { ev.stopPropagation(); ev.preventDefault() }}>
                ...
                <h1><a className='coolclick' href="https://launcher.openvoxel.studio/">Launcher</a></h1>

                <div className='bottom'>
                    <h1><a className='coolclick' href="https://discord.gg/Xhvb2wujVh">Our Discord</a></h1>
                </div>
            </nav>
        </>
    )
